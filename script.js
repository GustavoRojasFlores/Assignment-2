...
const quoteElement = document.getElementById('quote') // Assigns the quote text to a variable.

function newQuote () {
  const quoteValue = Math.round(Math.random() * 11) // Assigns a random number between 1 and 10 to a variable named quoteValue
  if (quoteValue === 1) {
